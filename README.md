...
5. Install the Handlebars npm package: `npm install express-handlebars`.//DONE at main level of folder Node Express Handlebars

6. Install MySQL npm package: `npm install mysql`.//DONE

7. Require the following npm packages inside of the server.js file: //DONE
   - express
...
1. Inside your `burger` directory, create a folder named `views`.//DONE
   ...
   - Create the `layouts` directory inside `views` directory.//DONE
     ...
     - Setup the `index.handlebars` to have the template that Handlebars can render onto.//TO CHECK

     - Create a button in `index.handlebars` that will submit the user input into the database.//TO CHECK
